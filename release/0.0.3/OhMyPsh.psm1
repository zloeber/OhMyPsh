...
Function Add-OMPAutoLoadModule {
    ...
    .LINK
        https://www.github.com/zloeber/OhMyPsh/tree/master/release/0.0.3/docs/Add-OMPAutoLoadModule.md
    #>
    [CmdletBinding()]
	param (
...
Function Add-OMPPersonalFunction {
    ...
    .EXTERNALHELP OhMyPsh-help.xml
    .LINK
        https://www.github.com/zloeber/OhMyPsh/tree/master/release/0.0.3/docs/Add-OMPPersonalFunction.md
    #>
    [CmdletBinding()]
	param (
        [Parameter(Position = 0, Mandatory = $true)]
...
Function Add-OMPPlugin {
    ...
    .EXTERNALHELP OhMyPsh-help.xml
    .LINK
        https://www.github.com/zloeber/OhMyPsh/tree/master/release/0.0.3/docs/Add-OMPPlugin.md
    #>
    [CmdletBinding()]
	param (
        [Parameter(Position = 0, Mandatory = $true, ValueFromPipeline = $true)]
...
Function Add-OMPProfileSetting {
    ...
    .EXTERNALHELP OhMyPsh-help.xml
    .LINK
        https://www.github.com/zloeber/OhMyPsh/tree/master/release/0.0.3/docs/Add-OMPProfileSetting.md
    #>
    [CmdletBinding()]
	param (
        [Parameter(Position = 0, Mandatory = $true)]
...
Function Export-OMPProfile {
    ...
    .EXTERNALHELP OhMyPsh-help.xml
    .LINK
        https://www.github.com/zloeber/OhMyPsh/tree/master/release/0.0.3/docs/Export-OMPProfile.md
    #>
    [CmdletBinding()]
    Param (
        [Parameter()]
...
function Get-OMPLoadedFunction {
    ...
    .EXTERNALHELP OhMyPsh-help.xml
    .LINK
        https://www.github.com/zloeber/OhMyPsh/tree/master/release/0.0.3/docs/Get-OMPLoadedFunction.md
    #>
...
function Get-OMPPlugin {
    ...
    .EXTERNALHELP OhMyPsh-help.xml
    .LINK
        https://www.github.com/zloeber/OhMyPsh/tree/master/release/0.0.3/docs/Get-OMPPlugin.md
    #>
...
Function Get-OMPProfilePath {
    ...
    .EXTERNALHELP OhMyPsh-help.xml
    .LINK
        https://www.github.com/zloeber/OhMyPsh/tree/master/release/0.0.3/docs/Get-OMPProfilePath.md
    #>
    [CmdletBinding()]
	param ()
...
Function Get-OMPProfileSetting {
    ...
    .EXTERNALHELP OhMyPsh-help.xml
    .LINK
        https://www.github.com/zloeber/OhMyPsh/tree/master/release/0.0.3/docs/Get-OMPProfileSetting.md
    #>
    [CmdletBinding()]
	param (
        [Parameter(Position = 0, ValueFromPipeline = $true)]
...
Function Get-OMPPromptColor {
    ...
    .EXTERNALHELP OhMyPsh-help.xml
    .LINK
        https://www.github.com/zloeber/OhMyPsh/tree/master/release/0.0.3/docs/Get-OMPPromptColor.md
    #>
    [CmdletBinding()]
	param ()
...
Function Get-OMPPSColor {
    ...
    .EXTERNALHELP OhMyPsh-help.xml
    .LINK
        https://www.github.com/zloeber/OhMyPsh/tree/master/release/0.0.3/docs/Get-OMPPSColor.md
    #>
    [CmdletBinding()]
	param ()
...
function Get-OMPTheme {
    ...
    .EXTERNALHELP OhMyPsh-help.xml
    .LINK
        https://www.github.com/zloeber/OhMyPsh/tree/master/release/0.0.3/docs/Get-OMPTheme.md
    #>
...
Function Import-OMPModule {
    ...
    .EXTERNALHELP OhMyPsh-help.xml
    .LINK
        https://www.github.com/zloeber/OhMyPsh/tree/master/release/0.0.3/docs/Import-OMPModule.md
    #>
    [CmdletBinding()]
	param (
        [Parameter(Position = 0, Mandatory = $true, ValueFromPipeline = $true)]
...
Function Import-OMPProfile {
    ...
    .EXTERNALHELP OhMyPsh-help.xml
    .LINK
        https://www.github.com/zloeber/OhMyPsh/tree/master/release/0.0.3/docs/Import-OMPProfile.md
    #>
    [CmdletBinding()]
    Param (
        [Parameter()]
...
Function Invoke-OMPPluginShutdown {
    ...
    .EXTERNALHELP OhMyPsh-help.xml
    .LINK
        https://www.github.com/zloeber/OhMyPsh/tree/master/release/0.0.3/docs/Invoke-OMPPluginShutdown.md
    #>
    [CmdletBinding()]
	param (
        [Parameter(Position = 0, ValueFromPipeline = $true)]
...
Function New-OMPPlugin {
    ...
    .EXTERNALHELP OhMyPsh-help.xml
    .LINK
        https://www.github.com/zloeber/OhMyPsh/tree/master/release/0.0.3/docs/New-OMPPlugin.md
    #>
    [CmdletBinding()]
	param (
        [Parameter(Position = 0, Mandatory = $true)]
...
Function Optimize-OMPProfile {
 <#
    .EXTERNALHELP OhMyPsh-help.xml
    .LINK
        https://www.github.com/zloeber/OhMyPsh/tree/master/release/0.0.3/docs/Optimize-OMPProfile.md
    #>
    [CmdletBinding()]
    Param()
...
Function Remove-OMPAutoLoadModule {
    ...
    .EXTERNALHELP OhMyPsh-help.xml
    .LINK
        https://www.github.com/zloeber/OhMyPsh/tree/master/release/0.0.3/docs/Remove-OMPAutoLoadModule.md
    #>
    [CmdletBinding()]
	param (
        [Parameter(Position = 0, Mandatory = $true)]
...
Function Remove-OMPModule {
    ...
    .EXTERNALHELP OhMyPsh-help.xml
    .LINK
        https://www.github.com/zloeber/OhMyPsh/tree/master/release/0.0.3/docs/Remove-OMPModule.md
    #>
    [CmdletBinding()]
	param (
        [Parameter(Position = 0, Mandatory = $true)]
...
Function Remove-OMPPersonalFunction {
    ...
    .EXTERNALHELP OhMyPsh-help.xml
    .LINK
        https://www.github.com/zloeber/OhMyPsh/tree/master/release/0.0.3/docs/Remove-OMPPersonalFunction.md
    #>
    [CmdletBinding()]
	param (
        [Parameter(Position = 0, Mandatory = $true)]
...
Function Remove-OMPPlugin {
    ...
    .EXTERNALHELP OhMyPsh-help.xml
    .LINK
        https://www.github.com/zloeber/OhMyPsh/tree/master/release/0.0.3/docs/Remove-OMPPlugin.md
    #>
    [CmdletBinding()]
	param (
        [Parameter(Position = 0, Mandatory = $true, ValueFromPipeline = $true)]
...
Function Remove-OMPProfileSetting {
    ...
    .EXTERNALHELP OhMyPsh-help.xml
    .LINK
        https://www.github.com/zloeber/OhMyPsh/tree/master/release/0.0.3/docs/Remove-OMPProfileSetting.md
    #>
    [CmdletBinding()]
	param (
        [Parameter(Position = 0, Mandatory = $true)]
...
Function Restore-OMPOriginalAlias {
    ...
    .EXTERNALHELP OhMyPsh-help.xml
    .LINK
        https://www.github.com/zloeber/OhMyPsh/tree/master/release/0.0.3/docs/Restore-OMPOriginalAlias.md
    #>
    [CmdletBinding()]
	param ()
...
Function Restore-OMPOriginalConsole {
    ...
    .EXTERNALHELP OhMyPsh-help.xml
    .LINK
        https://www.github.com/zloeber/OhMyPsh/tree/master/release/0.0.3/docs/Restore-OMPOriginalConsole.md
    #>
    [CmdletBinding()]
	param ()
...
Function Restore-OMPOriginalPrompt {
    ...
    .EXTERNALHELP OhMyPsh-help.xml
    .LINK
        https://www.github.com/zloeber/OhMyPsh/tree/master/release/0.0.3/docs/Restore-OMPOriginalPrompt.md
    #>
    [CmdletBinding()]
	param ()
...
Function Restore-OMPOriginalPSDefaultParameter {
    ...
    .EXTERNALHELP OhMyPsh-help.xml
    .LINK
        https://www.github.com/zloeber/OhMyPsh/tree/master/release/0.0.3/docs/Restore-OMPOriginalPSDefaultParameter.md
    #>
    [CmdletBinding()]
	param ()
...
Function Restore-OMPOriginalTabCompletion {
    ...
    .EXTERNALHELP OhMyPsh-help.xml
    .LINK
        https://www.github.com/zloeber/OhMyPsh/tree/master/release/0.0.3/docs/Restore-OMPOriginalTabCompletion.md
    #>
    [CmdletBinding()]
	param ()
...
Function Set-OMPProfileSetting {
    ...
    .EXTERNALHELP OhMyPsh-help.xml
    .LINK
        https://www.github.com/zloeber/OhMyPsh/tree/master/release/0.0.3/docs/Set-OMPProfileSetting.md
    #>
    [CmdletBinding()]
	param (
        [Parameter(Position = 0, Mandatory = $true)]
...
Function Set-OMPTheme {
    ...
    .EXTERNALHELP OhMyPsh-help.xml
    .LINK
        https://www.github.com/zloeber/OhMyPsh/tree/master/release/0.0.3/docs/Set-OMPTheme.md
    #>
    [CmdletBinding()]
	param (
        [Parameter(Position = 0)]
...
Function Set-OMPWindowTitle {
    ...
    .EXTERNALHELP OhMyPsh-help.xml
    .LINK
        https://www.github.com/zloeber/OhMyPsh/tree/master/release/0.0.3/docs/Set-OMPWindowTitle.md
    #>
    [CmdletBinding()]
	param (
        [Parameter(Position = 0, Mandatory = $true)]
...
function Show-OMPHelp {
    ...
    .EXTERNALHELP OhMyPsh-help.xml
    .LINK
        https://www.github.com/zloeber/OhMyPsh/tree/master/release/0.0.3/docs/Show-OMPHelp.md
    #>
...
function Show-OMPStatus {
    ...
    .EXTERNALHELP OhMyPsh-help.xml
    .LINK
        https://www.github.com/zloeber/OhMyPsh/tree/master/release/0.0.3/docs/Show-OMPStatus.md
    #>
...
Function Test-OMPProfileSetting {
    ...
    .EXTERNALHELP OhMyPsh-help.xml
    .LINK
        https://www.github.com/zloeber/OhMyPsh/tree/master/release/0.0.3/docs/Test-OMPProfileSetting.md
    #>
    [CmdletBinding()]
	param (
        [Parameter(Position = 0, ValueFromPipeline = $true)]
